...
import injectDrawer, { InjectedDrawerProps } from './injectDrawer';
import { DrawableContent, DrawerSize } from './types';
...
class DrawerManager extends React.Component<DrawerManagerProps, DrawerManagerState> {
  ...
  render() {
    ...
    drawableContents.forEach(
      ({ component: WrappedComponent, additionalProps, size, className, ...others }, index) => {
