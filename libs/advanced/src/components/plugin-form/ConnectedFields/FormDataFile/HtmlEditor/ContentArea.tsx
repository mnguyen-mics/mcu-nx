...
import { FieldCtor, FormSection } from '../../../../form';
...
import FormTextArea, { FormTextAreaProps } from '../../../../form/FormTextArea';
...
const FormTextAreaField: FieldCtor<FormTextAreaProps> =
  Field as new () => GenericField<FormTextAreaProps>;
const FormQuickUploadField: FieldCtor<QuickAssetUploadProps> =
  Field as new () => GenericField<QuickAssetUploadProps>;
