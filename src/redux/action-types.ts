import { createRequestTypes } from './ReduxHelper';
...
export const STORE_CONNECTED_USER = 'STORE_CONNECTED_USER';

export const KEYCLOAK_POST_LOGIN = 'KEYCLOAK_POST_LOGIN';
export const KEYCLOAK_POST_LOGIN_FAILURE = 'KEYCLOAK_POST_LOGIN_FAILURE';
export const KEYCLOAK_POST_LOGIN_SUCCESS = 'KEYCLOAK_POST_LOGIN_SUCCESS';
