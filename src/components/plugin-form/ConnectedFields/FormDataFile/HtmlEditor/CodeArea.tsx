...
import { FieldCtor, FormSection, FormCodeEdit } from '../../../../form';
import { FormCodeEditProps } from '../../../../form/FormCodeEdit';
import { reduxForm, InjectedFormProps, Field, Form, ConfigProps, GenericField } from 'redux-form';
import { EditContentLayout } from '../../../../layout';
import { Omit } from '../../../../../utils/Types';
import { injectDrawer } from '../../../../../components/drawer/index';
import { InjectedDrawerProps } from '../../../../../components/drawer/injectDrawer';
const { Content } = Layout;

const FormCodeField: FieldCtor<FormCodeEditProps> =
  Field as new () => GenericField<FormCodeEditProps>;
